...
var array_preguntas=
[
{ pregunta:"¿En qué partes está dividido un computador?" ,opciones:[{opcion:"Hardware y software", puntaje:1},{opcion:"Teclado y ratón", puntaje:0},{opcion:"Disco duro y procesador", puntaje:0},{opcion:"Usuario y maquina", puntaje:0}]}
,
{ pregunta:"¿Quién es el que envía una señal y espera una respuesta en la comunicación usuario-computador?" ,opciones:[{opcion:"Usuario", puntaje:1},{opcion:"Teclado", puntaje:0},{opcion:"Ratón", puntaje:0},{opcion:"Computador", puntaje:0}]}
,
{ pregunta:"¿Quién retorna una señal como respuesta en la comunicación usuario-computador?" ,opciones:[{opcion:"Computador", puntaje:1},{opcion:"Usuario", puntaje:0},{opcion:"Teclado", puntaje:0},{opcion:"Ratón", puntaje:0}]}
,
{ pregunta:"Si el hardware o el software están dañados, el usuario podrá:" ,opciones:[{opcion:"No usar el computador, ya que el software y el hardware deben estar buenos ambos", puntaje:1},{opcion:"Usar el computador, ya que el software y el hardware funcionan de forma independiente", puntaje:0},{opcion:"Desechar el computador", puntaje:0},{opcion:"No sabría que hacer", puntaje:0}]}

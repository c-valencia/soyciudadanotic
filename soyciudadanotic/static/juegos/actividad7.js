...
var array_preguntas=
[
{ pregunta:"¿Cuándo existe una interacción entre un usuario y un dispositivo?" ,opciones:[{opcion:"Cuando el usuario lo usa", puntaje:1},{opcion:"Cuando el usuario lo observa", puntaje:0},{opcion:"Cuando el usuario lee acerca del dispositivo", puntaje:0},{opcion:"Cuando el dispositivo es comprado", puntaje:0}]}
,
{ pregunta:"¿En qué consiste la interacción táctil?" ,opciones:[{opcion:"Cuando se interactúa con el dispositivo a través del contacto con una superficie", puntaje:1},{opcion:"Cuando el usuario le habla al dispositivo y este le responde", puntaje:0},{opcion:"Cuando el usuario oprime un botón y el dispositivo responde", puntaje:0},{opcion:"Cuando el usuario observa el dispositivo", puntaje:0}]}
,
{ pregunta:"¿En qué consiste la interacción por comando de voz?" ,opciones:[{opcion:"Cuando el usuario le habla al dispositivo y este le responde", puntaje:1},{opcion:"Cuando se interactúa con el dispositivo a través del contacto con una superficie", puntaje:0},{opcion:"Cuando el usuario oprime un botón y el dispositivo responde", puntaje:0},{opcion:"Cuando el usuario observa el dispositivo", puntaje:0}]}
,
{ pregunta:"¿En qué consiste la interacción por comando?" ,opciones:[{opcion:"Cuando el usuario oprime un botón y el dispositivo responde", puntaje:1},{opcion:"Cuando el usuario le habla al dispositivo y este le responde", puntaje:0},{opcion:"Cuando el usuario observa el dispositivo", puntaje:0},{opcion:"Cuando se interactúa con el dispositivo a través del contacto con una superficie", puntaje:0}]}
